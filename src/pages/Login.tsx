      ...
      <div className="flex items-center justify-center min-h-[70vh]">
        <div className="glass-surface rounded-xl p-10 w-full max-w-md border border-white/5">
          <div className="text-center mb-8">
            <LogIn size={40} className="text-primary-fixed mx-auto mb-4" />
            <h1 className="text-headline-lg font-bold text-primary mb-2">ENTRAR</h1>
            <p className="text-body-md text-on-surface-variant">Acesse sua conta OFFICE-X</p>
          </div>
          ...
          <p className="text-center text-label-sm text-on-surface-variant mt-6">
            Não tem conta?{' '}
            <Link to="/cadastro" className="text-primary-fixed hover:underline">
              Criar conta
            </Link>
          </p>
        </div>
