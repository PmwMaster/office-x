...
export function Hero() {
  return (
    <section id="visao-geral" className="relative pb-16">
      <ScrollVideo src="/video-project-7.mp4">
        <div className="max-w-xl space-y-8 lg:-translate-x-8">
          ...
          <h1 className="text-[clamp(40px,6vw,72px)] font-bold leading-[0.92] tracking-[-0.03em] text-white">
            Vortex Apex
            <br />
            <span className="text-white/60">Prime</span>
          </h1>
          <p className="text-[17px] leading-relaxed text-white/70 max-w-md">
            Imersão absoluta. Projetado para setups profissionais, streaming e gameplay competitivo de elite.
          </p>
